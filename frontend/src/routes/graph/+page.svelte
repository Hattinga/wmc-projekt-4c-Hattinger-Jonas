...
<div style="width:100%;height:100%;position:relative;overflow:hidden;background:#fafaf8;font-family:Inter,system-ui,sans-serif;color:#1a1a2e;">
  ...
  <!-- Topbar -->
  <div class="pl-14 pr-5 sm:px-5" style="position:absolute;top:0;left:0;right:0;height:56px;display:flex;align-items:center;gap:14px;background:rgba(255,255,255,0.85);backdrop-filter:blur(10px);border-bottom:1px solid rgba(26,26,46,0.08);z-index:3;">
  ...
  <div class="hidden sm:flex" style="position:absolute;top:76px;left:20px;bottom:20px;width:240px;background:#fff;border-radius:12px;padding:16px;border:1px solid rgba(26,26,46,0.08);box-shadow:0 4px 16px rgba(26,26,46,0.04);flex-direction:column;gap:14px;z-index:2;overflow:auto;">
